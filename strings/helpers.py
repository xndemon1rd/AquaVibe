...
Useful utilities and diagnostics are listed in the other help sections.
"""
...
• /mongochk : ᴄʜᴇᴄᴋ ᴛʜᴇ ᴅᴀᴛᴀʙᴀꜱᴇ ᴄᴏɴɴᴇᴄᴛɪᴏɴ.
• /ip : ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴀɴ ɪᴘ ᴀᴅᴅʀᴇꜱꜱ.
• /domain : ɢᴇᴛ ᴅᴏᴍᴀɪɴ ɪɴғᴏʀᴍᴀᴛɪᴏɴ.
• /weather : ɢᴇᴛ ᴡᴇᴀᴛʜᴇʀ ғᴏʀ ᴀ ʟᴏᴄᴀᴛɪᴏɴ.
...
# ───────────────────────────────────────────────────────────────────────
HELP_30 = """
<b><u>📚 ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅꜱ</u></b>

This panel contains every registered command, including commands that are restricted to admins/owner. Use <code>/help</code> to browse feature categories.

<i>Use the buttons below to browse the complete command list.</i>
"""
