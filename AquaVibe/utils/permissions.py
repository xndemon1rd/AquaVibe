...
# ────────────────────────────────────────────────────────────
# Group owner / admin helpers (used by mass_actions.py)
# ────────────────────────────────────────────────────────────
...
async def is_owner_or_admin(client: Client, chat_id: int, user_id: int):
    owner_user = await get_group_owner(client, chat_id)
    if owner_user and (user_id == owner_user.id or user_id in ADMINS):
