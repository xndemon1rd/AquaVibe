...
from AquaVibe.utils.database import get_lang, set_lang
from AquaVibe.utils.decorators import ActualAdminCB, language, languageCB
...
@app.on_message(filters.command(["lang", "setlang"]) & ~BANNED_USERS)
@language
