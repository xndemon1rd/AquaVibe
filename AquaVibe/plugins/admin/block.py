...
@app.on_message(filters.command(["unblock"]) & ADMINS)
@language
...
@app.on_message(filters.command(["blocked", "blockedusers", "blusers"]) & ADMINS)
@language
async def admins_list(client, message: Message, _):
    if not BANNED_USERS:
